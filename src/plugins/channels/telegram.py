...
class TelegramBotChannel(BaseChannel):
    ...
    - Smart splitting for long messages.
    - On-demand handling of incoming photos and documents.
    - Methods for sending files from the agent to the user.
    """
    ...
    async def start(self, config: Dict[str, Any], router: "MessageRouter"):
        ...
        self.allowed_users = config.get("allowed_user_ids", [])
